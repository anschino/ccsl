...
A research project titled __"Safety Analysis for the Standard Input and Output Devices in All-In-One PCs (일체형 PC의 기본 입출력 장치 안전성 분석 연구)"__ funded by _The Affiliated Institute of Electronics and Telecommunications Research Institute (ETRI)_ _(한국전자통신연구원 부설연구소)_ just began.      
